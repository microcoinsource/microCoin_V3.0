...
Debian MRC-QT and daemon
Make sure that the required packages for Qt5 development of your distribution are installed, 
for Debian and Ubuntu these are: 
apt-get install 
qt5-default 
qt5-qmake 
qtbase5-dev-tools 
...
Code:
git clone https://github.com/microcoinsource/microCoin_V3.0.git
...
Copy microcoind to make it executable for every user on the system.
Code:
...
That kind of Proof of Burn address format is used example for Counterparty and Dogeparty.
