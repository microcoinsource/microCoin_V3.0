...
bool CBloomFilter::IsRelevantAndUpdate(const CTransaction& tx, const uint256& hash)
{
    ...
    for (unsigned int i = 0; i < tx.vout.size(); i++)
    {
        ...
        // Match if the filter contains any arMRCary script data element in any scriptPubKey in tx
    ...
    BOOST_FOREACH(const CTxIn& txin, tx.vin)
    {
        ...
        // Match if the filter contains any arMRCary script data element in any scriptSig in tx
